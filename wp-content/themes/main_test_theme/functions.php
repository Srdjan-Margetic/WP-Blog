...
// Load our main stylesheet.
    wp_enqueue_style('style-bootstrap', get_stylesheet_directory_uri() . '/dist/css/bootstrap.min.css', false, get_stylesheet_directory() . '/dist/css/bootstrap.min.css', 'all');
